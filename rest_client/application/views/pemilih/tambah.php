...
<head>
    ...
    <title><?= isset($title) ? $title : 'Tambah Data Pemilih' ?> - E-Voting HIMSI</title>
...
<body>
    ...
    <div class="container main-content">
        ...
        <div class="page-header">
            <h1><i class="fas fa-user-plus me-3"></i>Tambah Data Pemilih</h1>
            <p>Menambahkan pemilih baru ke sistem e-voting HIMSI</p>
        </div>
        ...
        <div class="glass-card">
            ...
            <!-- Form -->
            <?= form_open('pemilih/simpan', ['class' => 'needs-validation', 'novalidate' => true]); ?>
                <div class="row">
                    <div class="col-md-6">
